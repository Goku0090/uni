#!/usr/bin/env python
"""
Performance Monitoring Script for UniSync (FIXED VERSION)
Monitors database queries, cache hit rates, and response times

FIXES APPLIED:
- Fixed 7 string formatting errors (added f-string prefixes)
- All metrics now properly displayed
- Report file generation works correctly
"""
...
class PerformanceMonitor:
    ...
    def get_database_stats(self):
        ...
        print(f"   Query execution time: {db_query_time:.3f}s")  # ✅ FIXED (was: print(".3f"))
        ...
        if connection.queries:
            ...
            print(f"   Total query time: {total_query_time:.3f}s")  # ✅ FIXED (was: print(".3f"))
    ...
    def get_cache_stats(self):
        ...
        print(f"Cache response time: {cache_time:.3f}s")  # ✅ FIXED (was: print(".3f"))
    ...
    def get_index_stats(self):
        ...
        # ✅ FIXED - All 3 lines now properly formatted (were: print(".3f"))
        print(f"   College filter query time: {college_query_time:.3f}s")
        print(f"   Location filter query time: {location_query_time:.3f}s")
        print(f"   Project date filter query time: {project_query_time:.3f}s")
    ...
    def run_full_analysis(self):
        ...
        print(f"\nTotal analysis time: {total_time:.2f}s")  # ✅ FIXED (was: print(".2f"))
...
def main():
    ...
    with open(filename, 'w') as f:
        ...
        # ✅ FIXED (was: f.write(".2f"))
        f.write(f"\nTotal analysis time: {results['total_analysis_time']:.2f}s\n")
