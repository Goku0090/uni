...
function createCommentHTML(comment, projectId) {
    const avatarUrl = comment.user.profile_photo || 'https://via.placeholder.com/36?text=' + (comment.user.username[0] || 'U').toUpperCase();
        ...
        <div class="comment-item" data-comment-id="${comment.id}">
            <div class="comment-header">
                <div class="comment-author-info">
                    <img src="${avatarUrl}" alt="${comment.user.username}" class="comment-avatar" onerror="this.src='https://via.placeholder.com/36'">
                    <div>
